...
Top level access to the DNS servers is via AT_DNSServer_MicrosoftDNS_Manage
To create Zones is via AT_DNSZone_MicrosoftDNS_Manage
To manage each zone is via AT_DNSZone_$($zoneName)_Manage


Requires: 
AD powershell modules
Update the DN to reflect where AD Groups will be created
#>
...
{   
    ...
    #RootServer DN and Set READ for the AD Gropus - Allows conection to the DNS Server
